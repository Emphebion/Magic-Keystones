...
//***************************************************************************//
// Input variables:
byte input_array[12] = {0,0,0,0};
byte new_input_array[12] = {0,0,0,0};
byte input_pins[12] = {inputPIN1,inputPIN2,inputPIN3,inputPIN4};
...
unsigned long debounce_timeout = 100;  // Time before a skill activates (100 ms)
